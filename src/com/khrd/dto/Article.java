...
public class Article {
	...
	public String toString() {
		return "Article [article_no=" + article_no + ", writer_id=" + writer_id + ", writer_name=" + writer_name
				...
				+ ", content=" + content + ", getArticle_no()=" + getArticle_no() + ", getWriter_id()=" + getWriter_id()
				+ ", getWriter_name()=" + getWriter_name() + ", getTitle()=" + getTitle() + ", getRegdate()="
				+ getRegdate() + ", getModdate()=" + getModdate() + ", getRead_cnt()=" + getRead_cnt()
